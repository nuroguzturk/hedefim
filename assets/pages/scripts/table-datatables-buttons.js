    ...
    var initTable3 = function () {
        ...
        var oTable = table.dataTable({
            ...
            "language": {
				...
				"info": "_TOTAL_ öğenin _START_ to _END_ arası gösteriliyor..",
                "infoEmpty": "Herhangibir şey bulunamadı.",
                "infoFiltered": "(filtered1 from _MAX_ total entries)",
                "lengthMenu": "_MENU_ sayfa başına",
                "search": "Ara:",
                "zeroRecords": "Aradığınızı bulamadık."
            },
    ...
    var initAjaxDatatables = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "lengthMenu": [
                    [10, 20, 50, 100, 150, -1],
                    [10, 20, 50, 100, 150, "Tümü"] // change per page values here
                ],
